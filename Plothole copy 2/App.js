...
class App extends React.Component {
  ...
  sendUserDataHandler = () => {
    ...
    RNFS.readFile(this.state.photo.path, "base64")
    .then(res => this.setState({imageId: res}))
    .then(
      ...
      Alert.alert(
        'Pothole Added',
        'Pothole has been added. Kindly view and refresh the server for updates.',
        [
...
class All extends React.Component {
  ...
  removeCardHandler = (item) => {
    ...
    Alert.alert(
        'Pothole Deleted',
        'Pothole has been deleted. Kindly refresh the server for updates.',
        [
          {text: 'OK', onPress: () => console.log('OK Pressed')},
        ],
        {cancelable: false},
  ...
  goToCardHandler = (latitude,longitude) => {
    this.setState({
      userLocation: {
        latitude: latitude,
        longitude: longitude,
  ...
  render() {
    ...
    <View style={styles2.container}>
      ...
      getLocation={this.goToCardHandler}
      />
      </ScrollView>
    </View>
    );
